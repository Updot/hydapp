      ...
      children: [
        ...
        GestureDetector(
            ...
            child: iconFacebook != null
                ? UIUtil.makeImageWidget(iconFacebook!, boxFit: BoxFit.contain)
        ...
        GestureDetector(
            ...
            child: iconInstagram != null
                ? UIUtil.makeImageWidget(iconInstagram!, boxFit: BoxFit.contain)
        ...
        GestureDetector(
            ...
            child: iconTwitter != null
                ? UIUtil.makeImageWidget(iconTwitter!, boxFit: BoxFit.contain)
                : SvgPicture.asset(Res.ic_twitter_social, fit: BoxFit.contain)),
      ],
    );
  }
