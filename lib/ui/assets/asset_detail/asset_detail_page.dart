            ...
            return LayoutBuilder(builder: (context, constraints) {
              return Stack(
                children: [
                  ...
                  MyRefreshList(
                      key: Key(state.assetDetail!.id!.toString()),
                      textColorRefresh: Colors.white,
                      enablePullDown: true,
                      onRefresh: () {
                        _assetDetailBloc.add(
                            FetchAssetDetail(state.assetDetail!.id.toString()));
                        _assetDetailBloc.add(
                        ...
                        return Stack(
                          children: [
                            Container(
                              ...
                              padding: const EdgeInsets.only(top: sizeLarge),
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          MySocialMedia(
                                              title: state.assetDetail!
                                                  .titleSocialMedia,
                                              linkFacebook: state
                                                  .assetDetail!.linkFacebook,
                                              linkInstagram: state
                                                  .assetDetail!.linkInstagram,
                                              linkTwitter: state
                                                  .assetDetail!.linkTwitter,
                                              isHorizontal: false,
                                              padding: const EdgeInsets.only(
                                                  left: 0, right: 0)),
                                          const SizedBox(
                                          ...
                                          BlocBuilder<AssetDetailBloc,
                                              ...
                                              buildWhen: (previousState,
                                                  currentState) {
                                            return previousState.assetDetail!
                                                    .pickOneSuitable !=
                                            ...
                                            return CommunityList(
                                              onItemClickFav: (value) {
                                                if (state.userInfo!.isUser()) {
                                                  valueRefreshCommunity.value =
                                                      DateTime.now()
                                                          .toIso8601String();
                                                  _assetDetailBloc.add(
                                                      AddPostFavorite(value));
                                                } else {
                                                  NavigateUtil.openPage(context,
                                                      LoginPage.routeName);
                                                }
