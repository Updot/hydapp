...
class _ProfilePageState extends BaseState<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    super.build(context);
    final paddingTop = (_profileBloc.state.userInfo!.isUser())
        ? sizeLargexxx
        : sizeImageNormalx;
              ...
              body: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    if (state.userInfo!.isUser()) renderHeader(state),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsets.only(
                                            ...
                                            right: sizeNormalxxx),
                                        child: Column(
                                            children: (state.userInfo!.isUser()
                                                    ? moreItems
                                                    : moreItemsForGuest)
                                                .asMap()
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            index ==
                    (state.userInfo!.isUser() ? moreItems : moreItemsForGuest)
                            .length -
                        1
                ? const SizedBox()
                : const Padding(
