                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ActivityTool(
                                  ...
                                  onClickShare: () {
                                    Share.share(state.activityModel!.shareUrl!);
                                  },
                                  onClickReport: () {
                                ...
                                ListView.builder(
                                  ...
                                  itemCount: state.activityModel!.detail!.length,
                                ),
                                const SizedBox(height: sizeSmallxxx),
                                if (state.listCommunities!.isNotEmpty)
                                  CommunityList(
                                ...
                                if ((state.activitiesAlsoLike!.length) > 0)
                                  MyTextView(
                                    text: Lang
                                ...
                                Container(
                                  child: MyIndicator(
                                    ...
                                    controller: _controller,
                                    itemCount: state.activitiesAlsoLike!.length,
                                  ),
                                ),
                                const SizedBox(height: sizeNormal),
                              ],
