...
class NotificationHistoryScreenState
  ...
  Widget notificationItemWidget(
      NotificationHistoryModel item, BuildContext context) {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MyTextView(
                        text: DateUtil.convertDateTime(item.datetime.toString(),
    ...
    switch (item.type) {
      ...
      case PARAM_COMMENT:
        NavigateUtil.openPage(context, CommunityDetailScreen.routeName,
            argument: {'id': item.data!.postId!.toString()}).then((value) {
