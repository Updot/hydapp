    ...
    switch (event.runtimeType) {
      case FetchMoreNotificationData:
        final result = await notificationRepository!
            .fetchNotificationHistory(pageIndex: indexPage + 1, limit: 10);
        yield result.fold(
          (failure) => state,
          (value) {
            if (value.isNotEmpty) {
        ...
        break;
      case TagReady:
        yield handleTagReady(event as TagReady);
        break;
      case FetchNotificationData:
        indexPage = 0;
        final result = await notificationRepository!
            .fetchNotificationHistory(pageIndex: indexPage, limit: 10);
        yield* notificationHistoryInteract!
            .handleNotificationHistoryResult(result, state);
        break;
      ...
      case TurnOffNotification:
        ...
        await notificationRepository!
            .turnOffNotificationFromOwner(postId, 'add', type);
        // yield* notificationHistoryInteract
