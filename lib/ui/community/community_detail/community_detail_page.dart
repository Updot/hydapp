...
class CommunityDetailScreenState extends BaseState<CommunityDetailScreen> {
  ...
  void initBasicInfo() {
    ...
    final id = widget.communityPost!.id! != null
        ? widget.communityPost!.id!.toString()
        : widget.id;
  ...
  void openAssetDetail(PlaceModel value) {
    NavigateUtil.openPage(context, AssetDetailScreen.routeName,
      ...
      _communityDetailBloc.add(FetchPostDetail(
          _communityDetailBloc.state.postDetail!.id.toString()));
    });
  }
