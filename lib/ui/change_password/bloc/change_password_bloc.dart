  ...
  Stream<ChangePasswordState> mapEventToState(
    ...
    switch (event.runtimeType) {
      ...
      case CheckOldPassword:
        yield* _checkOldPass(event as CheckOldPassword);
        break;
      case PasswordChanged:
        yield* _checkPass(event as PasswordChanged);
        break;
      case ConfirmPasswordChanged:
        yield* _checkConfirmPassword(event as ConfirmPasswordChanged);
        break;
      case SubmitNewPassword:
        yield* _changeNewPass(event as SubmitNewPassword);
        break;
    }
  }
