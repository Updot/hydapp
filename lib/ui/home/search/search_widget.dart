...
class _SearchWidgetState extends State<SearchWidget> {
  ...
  void initState() {
    homeSearchBloc
        .add(GetSearchRecentEvent(experienceId: widget.experienceId!));
    super.initState();
  }
              ...
              child: Column(
                ...
                children: [
                  if (recentToday.isNotEmpty) ...[
                    ...
                    ...List.generate(recentToday.length, (index) {
                  ...
                  if (recentYesterday.isNotEmpty) ...[
                    ...
                    ...List.generate(recentYesterday.length, (index) {
