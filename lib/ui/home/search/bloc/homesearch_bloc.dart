  ...
  Stream<HomeSearchState> mapEventToState(
    ...
    switch (event.runtimeType) {
      case SearchkeyWordEvent:
        yield* _mapSearchChangedEvent(event as SearchkeyWordEvent);
        break;
      case SelectExperienceSearch:
        yield* _mapRefreshSearchChangedEvent(event as SelectExperienceSearch);
        break;
      case ClearSearchEvent:
        yield* _mapClearSearchEvent(event as ClearSearchEvent);
        break;
      case FocusFieldSearchEvent:
        yield* _mapFocusFieldSearchEvent(event as FocusFieldSearchEvent);
        break;
