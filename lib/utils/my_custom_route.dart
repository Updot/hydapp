        ...
        case FilterPage.routeName:
          ...
          return MyCustomRoute(
            builder: (_) => FilterPage(
              areaItem: currentArea!,
              filterOptSelected: (dataArg!.containsKey('filter') != null ? dataArg.containsKey('filter') : false)
                  ? dataArg['filter']
                  : null,
            ),
            settings: settings,
        ...
        case NotificationSettingScreen.routeName:
          ...
          return MyCustomRoute(
            builder: (_) => NotificationSettingScreen(
                dataArg!.containsKey('firstTime') != null ? dataArg.containsKey('firstTime') : false
                    ? dataArg['firstTime']
                    : false),
            settings: settings,
          );
        ...
        case ActivityDetailScreen.routeName:
          return MyCustomRoute(
            builder: (_) => ActivityDetailScreen(
              item: settings.arguments as ActivityModel,
            ),
            settings: settings,
          );
