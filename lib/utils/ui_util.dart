...
class UIUtil {
  ...
  static Future<bool> checkPermissionCameraAndPhoto(
    ...
    return (status.isGranted || statuses[Permission.camera]!.isGranted != null ? statuses[Permission.camera]!.isGranted :
            false) &&
        (statusPhoto.isGranted || statuses[Permission.photos]!.isGranted != null ? statuses[Permission.photos]!.isGranted :
            false);
  }
