...
class AssetDetail extends PlaceModel {
  ...
  AssetDetail(
      ...
      required ExperienceModel experiences,
      required String phoneNumbers,
      required String mails,
      required String directUrls,
      required String titleSocialMedias,
      required String linkFacebooks,
      required String linkInstagrams,
      required String linkTwitters}) {
