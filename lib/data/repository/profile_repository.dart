...
abstract class ProfileRepository {
  ...
  Future<Either<Failure, List<UserCommunityModel>>> fetchMyCommunity(
      String userId);
...
class ProfileRepositoryImpl extends Repository implements ProfileRepository {
  ...
  Future<void> saveListSaveItem(String id, List saveItem) async {
    return localDataSrc.saveSaveItem(id, saveItem as List<SaveItemModel>);
  }
  ...
  @override
  Future<void> saveListMyCommunity(String id, List userCommunity) {
    return localDataSrc.saveMyCommunity(
        id, userCommunity as List<UserCommunityModel>);
  }
}
